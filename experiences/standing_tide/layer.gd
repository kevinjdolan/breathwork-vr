extends Node3D
## A membrane standing where the warp-driven spread and the zoom-driven pull cancel.

const MEMBRANE_SHADER = preload("res://experiences/standing_tide/membrane.gdshader")
